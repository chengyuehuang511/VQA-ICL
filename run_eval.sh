...
srun --cpu_bind=v --accel-bind=gn /coc/testnvme/chuang475/miniconda3/envs/lavis_same/bin/python evaluate.py \
    ...
    --textvqa_train_questions_json_path "/coc/pskynet4/chuang475/projects/vlm_robustness/tmp/datasets/textvqa/train/train_questions_vqa_format.json" \
    --textvqa_train_annotations_json_path "/coc/pskynet4/chuang475/projects/vlm_robustness/tmp/datasets/textvqa/train/train_annotations_vqa_format.json" \
    --textvqa_test_questions_json_path "/coc/pskynet4/chuang475/projects/vlm_robustness/tmp/datasets/textvqa/val/val_questions_vqa_format.json" \
    --textvqa_test_annotations_json_path "/coc/pskynet4/chuang475/projects/vlm_robustness/tmp/datasets/textvqa/val/val_annotations_vqa_format.json" \
    --vizwiz_train_image_dir_path "/srv/datasets/vizwiz/data/Images/" \
    --vizwiz_test_image_dir_path "/srv/datasets/vizwiz/data/Images/" \
    --vizwiz_train_questions_json_path "/coc/pskynet4/chuang475/projects/vlm_robustness/tmp/datasets/vizwiz/train/train_questions_vqa_format.json" \
    --vizwiz_train_annotations_json_path "/coc/pskynet4/chuang475/projects/vlm_robustness/tmp/datasets/vizwiz/train/train_annotations_vqa_format.json" \
    --vizwiz_test_questions_json_path "/coc/pskynet4/chuang475/projects/vlm_robustness/tmp/datasets/vizwiz/val/val_questions_vqa_format.json" \
    --vizwiz_test_annotations_json_path "/coc/pskynet4/chuang475/projects/vlm_robustness/tmp/datasets/vizwiz/val/val_annotations_vqa_format.json" \
